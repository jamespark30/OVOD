...
data_root = '/work/ovdet/data/coco/'
...
det_dataset = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='/work/ovdet/data/coco/wusize/instances_train2017_base.json',
...
ovd_dataset = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='/work/ovdet/data/coco/wusize/instances_train2017_base.json',   # the gt boxes of base categories might be used
    data_prefix=dict(img='train2017/'),
