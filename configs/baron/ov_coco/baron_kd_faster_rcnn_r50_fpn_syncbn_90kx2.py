...
clip_cfg = dict(          # ViT-B/32
    ...
    image_encoder=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='visual',
            checkpoint='/work/ovdet/checkpoints/clip_vitb32.pth')
    ),
    text_encoder=dict(
...
ovd_cfg = dict(type='BaronKD',
               boxes_cache=dict(json_path='/work/ovdet/data/coco/wusize/instances_train2017_base.json',
                                start_iter=20000,),
               use_gt=True,
               ...
               queue_cfg=dict(names=['clip_text_features', 'clip_image_features',
                                     ...
                                     'label_mask', 'box_coords', 'image_box_coords'],
                              lengths=[1024] * 7,
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            cls_temp=50.0,
            num_words=6,
            cls_embeddings_path='/work/ovdet/data/metadata/coco_clip_hand_craft_attn12.npy',
            bg_embedding='learn',
...
load_from = '/work/ovdet/checkpoints/res50_fpn_soco_star_400.pth'
